...
public class UmsRoleController extends BaseController<UmsRoleService, UmsRole> {
    ...
    public AjaxMessageRes<Integer> addUserResource(@PathVariable("roleId") String userId, @RequestBody MenuPermissionDTO menuResourceDTO) throws InvalidException {
    ...
    public AjaxMessageRes<Integer> addRolePermission(@PathVariable("userId") String userId, @RequestBody MenuPermissionDTO menuPermissionDTO) throws InvalidException {
    ...
    public AjaxMessageRes<List<UmsPermission>> getRolePermissions(@PathVariable("roleId") String roleId) throws InvalidException {

        return new AjaxMessageRes<>(umsRoleService.getPermissionsWithCategory(roleId));
    }

    @GetMapping("/menu/get/{roleId}")
    @ResponseBody
    @ApiOperation("获取角色拥有的菜单")
    public AjaxMessageRes<List<UmsMenu>> getRoleMenus(@PathVariable("roleId") String roleId) throws InvalidException {
