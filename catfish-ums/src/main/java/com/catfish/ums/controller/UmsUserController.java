...
public class UmsUserController extends BaseController<UmsUserService, UmsUser> {
    ...
    @ResponseBody
    public AjaxMessageRes<Object> login(@RequestBody @Valid UmsUserLoginDTO umsUserLoginDTO, BindingResult result) {
    ...
    @ResponseBody
    public AjaxMessageRes<UserInfo> info() {
    ...
    public AjaxMessageRes<Integer> addUserRole(@PathVariable("userId") String userId, @RequestBody List<String> roleIds) throws InvalidException {
    ...
    public AjaxMessageRes<Integer> addUserResource(@PathVariable("userId") String userId, @RequestBody List<String> resourceIds) throws InvalidException {
    ...
    public AjaxMessageRes<Integer> addUserPermission(@PathVariable("userId") String userId, @RequestBody MenuPermissionDTO menuPermissionDTO) throws InvalidException {
    ...
    public AjaxMessageRes<List<UmsResource>> getUserMenus(@PathVariable("userId") String userId) throws InvalidException {
    ...
    public AjaxMessageRes<List<UmsResource>> getUserResources(@PathVariable("userId") String userId) throws InvalidException {
    ...
    public AjaxMessageRes<List<UmsRole>> getUserRoles(@PathVariable("userId") String userId) throws InvalidException {
    ...
    public AjaxMessageRes<List<UmsPermission>> getUserPermissions(@PathVariable("userId") String userId) throws InvalidException {
    ...
    @Override
    public AjaxMessageRes<Object> search(PageReq pageDTO, UmsUser record) {
    ...
    @ApiOperation("根据实体创建")
    @Override
    public AjaxMessageRes<Object> create(@RequestBody @Validated({AddGroup.class}) UmsUser umsUser) {
    ...
    public AjaxMessageRes<Object> regist(@RequestBody @Validated({AddGroup.class}) UmsUser umsUser) {
